...
python -m generate_3DDuke --market_path ../Duke/pytorch/
...
def save_mesh(img, img_path, split, proc_param, joints, verts, cam):
    ...
    obj_mesh_name = '../3D-Person-reID/3DDuke/%s/%s/%s.obj'%( split, os.path.basename(os.path.dirname(img_path)), os.path.basename(img_path) )
